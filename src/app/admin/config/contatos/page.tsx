...
export default async function ConfigSectionPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="mt-3 font-[family-name:var(--font-manrope)] text-[30px] font-medium tracking-[-0.02em]">Contatos</h1>
      <ConfigForm business={business} orbiColors={orbiColors} heroGradient={heroGradient} section="contatos" />
    </div>
  );
}
