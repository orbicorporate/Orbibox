...
export const VITRINE_THEMES: VitrineTheme[] = [
  {
    ...
    photos: [
      p("moda-01.jpg"), p("moda-02.jpg"), p("moda-03.jpg"), p("moda-04.jpg"),
      p("moda-05.jpg"), p("moda-06.jpg"), p("moda-07.jpg"), p("moda-08.jpg"),
    ],
    boxes: [
