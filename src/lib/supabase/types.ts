...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      content_items: { Row: { target_url: string | null; link_kind: string | null; ai_optimized: boolean; ai_score: number | null; box_color: string; footer_color: string | null; title_placement: string; box_style: string; starts_at: string | null; ends_at: string | null; brand_label: string | null; layout_size: string; business_id: string; created_at: string; description: string | null; gallery_urls: string[]; gallery_ratio: string | null; photo_format: string | null; id: string; image_is_placeholder: boolean; image_url: string | null; images: Json; position: number; price: number | null; price_type: string; price_max: number | null; source_url: string | null; status: string; title: string; type: string; updated_at: string; highlight_stat: string | null; orbi_hook: string | null; highlights: string[] | null }
